...
# Produce a latex table with a booktabs format for the Table 1 counts.
...
# knitr::kable(table_fdr)
```

|            | No filter| Occurrence filter| E-value filter| Inference|   Cluster| Isotopologue cluster|
|:-----------|---------:|-----------------:|--------------:|---------:|---------:|--------------------:|
|PrSM        |     1.253|             0.221|          0.079|     0.079| 0.0480000|             0.048000|
|Proteoform  |     3.838|             0.404|          0.129|     0.129| 0.1109057|             0.122399|
|AA sequence |     7.094|             0.848|          0.315|     0.315| 0.1390000|             0.139000|
|Gene        |    17.057|             2.090|          0.784|     1.259| 0.5690000|             0.569000|
